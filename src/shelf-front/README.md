...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/vJUKP38YB3)
...
```sh
npx nx serve shelf-front
```

To create a production bundle:

```sh
npx nx build shelf-front
```

To see all available targets to run for a project, run:

```sh
npx nx show project shelf-front
```
